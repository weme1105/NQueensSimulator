...
export function installAnnotationCanvas(app: AnnotationBridge): void {
  ...
  style.textContent=`
    ...
    body.nq-play-mode .annotation-tools{display:flex}.annotation-row{display:flex;align-items:center;gap:7px;flex-wrap:wrap}.annotation-tools button,.annotation-tool-select{padding:7px 9px}.annotation-tools button.active{outline:3px solid #444;background:#fff}.annotation-tool-select{width:auto;min-width:112px;max-width:132px;flex:0 0 auto;border:1px solid #eaded8;border-radius:9px;background:#fff;color:inherit;font:inherit}.annotation-more-toggle{margin-left:auto}.annotation-more-panel{display:none;align-items:center;gap:7px;flex-wrap:wrap;padding-top:7px;border-top:1px solid #eaded8}.annotation-tools.more-open .annotation-more-panel{display:flex}.annotation-tools label{display:flex;align-items:center;gap:4px;font-size:12px;white-space:nowrap}.annotation-tools input[type=color]{width:34px;height:30px;padding:2px;border-radius:7px}.annotation-tools input[type=range]{width:86px;padding:0}
