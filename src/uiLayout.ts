...
export function installUiLayout(app: UiBridge): void {
  ...
  .nq-operation-panel{display:none;position:static;flex:1 0 100%;width:100%;padding:12px 14px;border:1px solid #eaded8;border-radius:12px;background:#fff;box-shadow:0 8px 20px #0001;line-height:1.65;font-size:13px}.nq-operation-panel.open{display:block}.nq-operation-panel b{display:block;margin-bottom:5px;font-size:14px}
  ...
  @media(max-width:850px){.nq-app-bar{padding:7px 8px;min-height:44px;gap:6px}.nq-edit-actions,.nq-play-actions{gap:6px}.nq-size-picker{grid-template-columns:30px 46px 30px;grid-template-rows:21px 34px 21px;padding:2px 4px}.nq-size-current{font-size:20px}}
  `;
